import unittest
from codewars.TYakushevych import ky6  as check_balance
...
class BalanceTest(unittest.TestCase):
    ...
    def test_balance_equal(self):
        self.assertEqual(check_balance.balance(self.b1), self.b1sol)
        self.assertEqual(check_balance.balance(self.b2), self.b2sol)

    def test_balance_not_equal(self):
        self.assertNotEqual(check_balance.balance(self.b2), self.b1sol)
        self.assertNotEqual(check_balance.balance(self.b1), self.b2sol)

    def test_balance_returns_string(self):
        self.assertIsInstance(check_balance.balance(self.b1), str)
        self.assertIsInstance(check_balance.balance(self.b2), str)

    def test_keywords_in_balance(self):
        result = check_balance.balance(self.b1)
